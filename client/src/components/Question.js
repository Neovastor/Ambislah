        ...
        <div className="flex flex-col gap-y-4 items-center p-5">
          ...
          <div className="grid grid-cols-2 gap-1 max-w-screen-lg">
            ...
            {/* <div>
              ...
              <div className="relative">
                <img className="top-0 object-fill" src="/mil-but.png" alt=".." /> 
                <button className="absolute top-0 h-11 rounded-lg p-2 transform translate-x-[100px] translate-y-[25px] text-xl bg-transparant hover:bg-red-600 text-gray-200"> {question.choose[1]} </button>
              </div>
              <div className="relative">
                <img className="top-0 object-fill" src="/mil-but.png" alt=".." /> 
                <button className="absolute top-0 h-11 rounded-lg p-2 transform translate-x-[100px] translate-y-[25px] text-xl bg-transparant hover:bg-red-600 text-gray-200"> {question.choose[2]} </button>
              </div>
              <div className="relative">
                <img className="top-0 object-fill" src="/mil-but.png" alt=".." /> 
                <button className="absolute top-0 h-11 rounded-lg p-2 transform translate-x-[100px] translate-y-[25px] text-xl bg-transparant hover:bg-red-600 text-gray-200"> {question.choose[3]} </button>
              </div>
          </div>
