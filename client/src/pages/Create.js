    ...
    return (
        <section>
            <div className="grid grid-cols-8 pt-12">
                <div className="bg-gray-200 my-2 p-2 col-span-7">
                    <form className="flex flex-col gap-y-4 items-center p-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex">
                                ...
                                <button className="rounded-full p-2 w-10 hover:bg-green-400 text-white"> &#10004; </button>
                            </div>
                            <div className="flex">
                ...
                <div className="bg-red-300 h-32 my-2 p-2">Button sound</div>
            </div >
        </section >
    )
}