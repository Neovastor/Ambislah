          ...
          <div className="bg-gray-200 my-2 p-2 col-span-7 h-screen">
            <form className="flex flex-col gap-y-4 items-center p-5">
              <input
                ...
                className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400"
              />
              <input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex">
                  <input
                    ...
                    className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400"
                  />
                  <button className="rounded-full p-2 w-10 hover:bg-green-400 text-gray-200">
