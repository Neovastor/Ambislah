...
export default function Home() {
    return (
        <>
            <div className="grid grid-cols-6 gap-2 md-max:grid-cols-3">
                {/* <div className="flex flex-wrap justify-center md-max:flex-col md-max:items-center "> */}
                <div className="bg-red-500 box-border h-32 w-full p-4 border-4 md-max:col-span-4">box username</div>
