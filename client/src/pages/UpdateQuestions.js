        ...
        <div className="pt-12 md-max:flex md-max:flex-col-reverse">
            <div className="bg-gray-200 my-2 p-2 col-span-7 h-full">
                <form onSubmit={handleSubmit(saveData)} className="flex flex-col gap-y-4 items-center p-5">
                    <input defaultValue={dataQuestion.dataQuizzes.question}  {...register('inputQuestion')} placeholder="Start typing your question" className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400" />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col">
                            ...
                            <div className="flex">
                                <input defaultValue={dataQuestion.dataQuizzes.choose[0]}  {...register('input1')} placeholder="add answer 1" className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400" />
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex">
                                <input defaultValue={dataQuestion.dataQuizzes.choose[1]} {...register('input2')} placeholder="add answer 2" className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400" />
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex">
                                <input defaultValue={dataQuestion.dataQuizzes.choose[2]} {...register('input3')} placeholder="add answer 3" className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400" />
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex">
                                <input defaultValue={dataQuestion.dataQuizzes.choose[3]} {...register('input4')} placeholder="add answer 4" className="w-full px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-green-400" />
